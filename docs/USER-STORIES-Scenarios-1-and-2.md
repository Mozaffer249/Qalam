...
> **Split docs:** Scenario 2 full stories → [USER-STORIES-Scenario-2.md](USER-STORIES-Scenario-2.md)
...
5. [Scenario 2 — Open Session Request](USER-STORIES-Scenario-2.md) _(standalone file)_
...
| **2** | طلب جلسات مفتوح | Student **publishes an open session request** → matching notifies teachers → teachers **submit offers** → student accepts → pay → sessions run | **Student CRUD slice implemented**; matching, offers, chat, admin, payment **planned** — see [USER-STORIES-Scenario-2.md](USER-STORIES-Scenario-2.md) |
...
| Area | Count | Maturity |
|------|-------|----------|
| S2 Student (`S2-ST-*`) | 12 | 7 implemented, 1 partial, 4 planned |
| S2 Teacher (`S2-TE-*`) | 11 | all planned |
| S2 Admin (`S2-AD-*`) | 8 | all planned |

Role specs: [TEACHER-ROLE-Scenario2.md](TEACHER-ROLE-Scenario2.md) · [ADMIN-ROLE-Scenario2.md](ADMIN-ROLE-Scenario2.md)
