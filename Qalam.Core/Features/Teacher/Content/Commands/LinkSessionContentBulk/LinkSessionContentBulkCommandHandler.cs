...
public class LinkSessionContentBulkCommandHandler : ResponseHandler,
    IRequestHandler<LinkSessionContentBulkCommand, Response<List<TeacherSessionContentLinkDto>>>
{
    private readonly ITeacherRepository _teacherRepository;
    private readonly ITeacherContentService _contentService;

    public LinkSessionContentBulkCommandHandler(
    ...
    public async Task<Response<List<TeacherSessionContentLinkDto>>> Handle(
        LinkSessionContentBulkCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var links = await _contentService.LinkSessionContentBulkAsync(
            teacher.Id, request.ScheduleId, request.Data, cancellationToken);
