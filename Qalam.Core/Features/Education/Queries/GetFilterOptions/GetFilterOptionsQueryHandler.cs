        ...
        CancellationToken cancellationToken)
    {
        try
        {
            var state = new FilterStateDto
            {
                ...
                SkipTerm = request.SkipTerm,
                SkipDepartment = request.SkipDepartment,
                SkipEducationLevel = request.SkipEducationLevel,
                SkipAcademicProgram = request.SkipAcademicProgram,
                OtherSubjectsOnly = request.OtherSubjectsOnly,
                ParentSubjectId = request.ParentSubjectId,
                SubjectId = request.SubjectId,
                WritableValueIds = request.WritableValueIds,
                SkippedWritableSlotCodes = request.SkippedWritableSlotCodes,
                ContentUnitId = request.ContentUnitId,
                LessonIds = request.LessonIds,
                SkipLessons = request.SkipLessons,
