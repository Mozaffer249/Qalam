...
public class TeachingModeConfiguration : IEntityTypeConfiguration<TeachingMode>
{
    public void Configure(EntityTypeBuilder<TeachingMode> builder)
    {
        builder.ToTable("TeachingModes", "teaching");
        ...
        builder.HasMany(e => e.DomainTeachingModes)
               .WithOne(dtm => dtm.TeachingMode)
               .HasForeignKey(dtm => dtm.TeachingModeId)
