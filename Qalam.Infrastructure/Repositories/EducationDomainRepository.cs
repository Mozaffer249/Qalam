        ...
        return await _dbContext.EducationDomains
            ...
            .Select(d => new EducationDomainDto
            {
                ...
                EducationRule = d.EducationRule == null ? null : new EducationRuleDto
                {
                    ...
                    HasParentSubject = d.EducationRule.HasParentSubject,
                    EducationLevelAfterSubject = d.EducationRule.EducationLevelAfterSubject,
                    HasWritableFilters = d.EducationRule.HasWritableFilters,
