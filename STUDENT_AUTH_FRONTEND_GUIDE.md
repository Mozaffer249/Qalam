...
> Note: Router constant historically used path `VerifyOp` in some docs; the live controller route is **`VerifyOtp`**. Prefer `/Api/V1/Authentication/Student/VerifyOtp`.
