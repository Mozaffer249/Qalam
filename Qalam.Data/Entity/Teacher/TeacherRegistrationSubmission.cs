...
/// <summary>
/// A teacher's answer for one registration requirement (file, text, or boolean).
/// </summary>
public class TeacherRegistrationSubmission : AuditableEntity
{
    ...
    public TeacherRegistrationRequirement Requirement { get; set; } = null!;
