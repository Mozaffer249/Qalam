...
public static class WritableFilterSlotCodes
{
    ...
    public const string TechTool = "tech.tool";
    public const string TechCurriculum = "tech.curriculum";
    public const string TechOtherPath = "tech.other_path";
    public const string HobbiesInterestGroup = "hobbies.interest_group";
    public const string HobbiesOther = "hobbies.other";
