    ...
    public static IReadOnlyList<TeacherRegistrationRequirement> Create(DateTime? createdAt = null)
    {
        ...
        return new List<TeacherRegistrationRequirement>
        {
            new()
            {
                ...
                DescriptionAr = "هوية وطنية أو إقامة داخل السعودية، أو جواز/وثيقة تناسب بلد الإقامة خارجها",
                DescriptionEn = "National ID or Iqama inside Saudi Arabia, or passport/ID matching residence outside",
