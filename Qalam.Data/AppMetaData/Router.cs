namespace Qalam.Data.AppMetaData
{
    public static class Router
    {
        ...
        public const string AdminComplaints = Rule + "Admin/Complaints";
        public const string AdminComplaintCounts = AdminComplaints + "/Counts";
        public const string AdminComplaintById = AdminComplaints + "/{id:int}";
        public const string AdminComplaintAssign = AdminComplaintById + "/Assign";
        public const string AdminComplaintPriority = AdminComplaintById + "/Priority";
        public const string AdminComplaintRequestInfo = AdminComplaintById + "/RequestInfo";
        public const string AdminComplaintAdvance = AdminComplaintById + "/Advance";
        public const string AdminComplaintResolve = AdminComplaintById + "/Resolve";
        public const string AdminComplaintResolvePreview = AdminComplaintById + "/ResolvePreview";
        ...
        public const string StudentComplaintRespond = StudentComplaintById + "/Respond";
        public const string TeacherComplaints = Rule + "Teacher/Complaints";
        public const string TeacherComplaintById = TeacherComplaints + "/{id:int}";
        public const string TeacherComplaintRespond = TeacherComplaintById + "/Respond";
